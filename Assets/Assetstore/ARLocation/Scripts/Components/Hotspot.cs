...
namespace ARLocation
{
    ...
    public class Hotspot : MonoBehaviour
    {
        ...
        public void Activate()
        {
            ...
            Logger.Log("HIER wird intantiated");

            state.Instance = Instantiate(
                    HotspotSettings.Prefab,
                    HotspotSettings.AlignToCamera ? transform.position : arLocationRoot.position,
                    HotspotSettings.AlignToCamera ? transform.rotation : arLocationRoot.rotation);
